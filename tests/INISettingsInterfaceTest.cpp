...
{
    SettingsInterface *settings = new INISettingsInterface;
    settings->init();
    delete settings;
}

TEST_CASE("INISettingsInterface loadFromFile valid content")
{
    SettingsInterface *settings = new INISettingsInterface;
    settings->init();
...
TEST_CASE("INISettingsInterface loadFromFile invalid content")
{
    SettingsInterface *settings = new INISettingsInterface;
    settings->init();
    std::string fileName = "tmp.settingsinterface.test.2.ini";
    std::ofstream file(fileName);
...
TEST_CASE("INISettingsInterface create")
{
    SettingsInterface *settings = new INISettingsInterface;
    settings->init();
...
// section 2 does not fail as expected? opening an already opened file should fail
TEST_CASE("INISettingsInterface saveToFile", "[!hide]")
{
    SettingsInterface *settings = new INISettingsInterface;
    settings->init();
...
TEST_CASE("INISettingsInterface get")
{
    SettingsInterface *settings = new INISettingsInterface;
    settings->init();
...
TEST_CASE("INISettingsInterface remove")
{
    SettingsInterface *settings = new INISettingsInterface;
    settings->init();
    SECTION("key without section") {
...
TEST_CASE("INISettingsInterface hasValue")
{
    SettingsInterface *settings = new INISettingsInterface;
    settings->init();
    SECTION("key without section") {
...
TEST_CASE("INISettingsInterface change")
{
    SettingsInterface *settings = new INISettingsInterface;
    settings->init();
    SECTION("key without section") {
...
TEST_CASE("INISettingsInterface count")
{
    SettingsInterface *settings = new INISettingsInterface;
    settings->init();
    SECTION("key without section") {
