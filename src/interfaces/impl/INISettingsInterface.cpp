...
{
    std::string logPrefix = "INISettingsInterface::loadFromFile(const std::string &="
                            + fileName + "): ";
        ...
        while (std::getline(file, line)) {
            ...
            if (openBracket != std::string::npos
                ...
                if (hasSection) {
                    ...
                    Logger::debug << logPrefix << "Value \"" << value
                                  << "\" added to \"" << key << "\"";
                }
...
void INISettingsInterface::saveToFile(const std::string &fileName) const
{
    ...
    if (file.good()) {
        ...
        Logger::error << "INISettingsInterface::saveToFile(const std::string &="
